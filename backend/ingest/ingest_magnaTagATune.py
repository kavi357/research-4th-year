...
def ingest_fma(root_folder, max_songs=30
): 
    ...
    print(f"\n🎵 Starting MagnaTagATune ingestion from: {root_folder}\n")
    ...
    for subfolder in sorted(root_folder.rglob("*")):
        ...
        for file in subfolder.iterdir():
            ...
            try:
                ...
                # --- INSERT TRACK ---
                track_id = insert_track(DB_PATH, file.stem, str(file), duration, "magnaTagATune")
    ...
    print("\n🎉 Finished MagnaTagAtune ingestion.\n")


if __name__ == "__main__":
    ingest_fma("data/magnaTagATune")
